    ...
    <div className="flex flex-col items-center animate-in fade-in zoom-in-95 duration-500">
      ...
      <div className="no-print mt-12 p-8 bg-slate-900 rounded-[2.5rem] max-w-lg text-center shadow-2xl border border-slate-800">
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <span className="text-base font-black text-white tracking-tight">Windscreen Fitment Standard</span>
        </div>
        <p className="text-sm text-slate-400 leading-relaxed font-medium">
          PDF export is pre-scaled to exactly 90mm in diameter. Ensure your printer scaling is set to "100%" or "Actual Size" to maintain physical dimensions for standard windscreen holders.
        </p>
        <div className="mt-6 pt-6 border-t border-slate-800 flex justify-between items-center px-4">
           <div className="text-left">
              <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Print Diameter</p>
              <p className="text-xs font-bold text-white">90mm (Standard Disc)</p>
           </div>
           <div className="text-right">
              <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Page Layout</p>
              <p className="text-xs font-bold text-blue-500">Center Aligned A4</p>
           </div>
        </div>
      </div>
    </div>
